...
import { ChevronLeft, ChevronRight, MessageSquareQuote, CodeXml } from "lucide-react";

// Relation colors for badges: background + border only (text color set to black in span)
const relationColors: Record<string, string> = {
  Client: "bg-blue-300 border-blue-500",
  Colleague: "bg-green-300 border-green-500",
  Manager: "bg-purple-300 border-purple-500",
  "Research Mentor": "bg-amber-300 border-amber-500",
      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold font-mono mb-4 inline-block relative">
            ...
            <span className="text-[#000000]">Testimonials</span>
            <div className="h-1 w-36 bg-[#00FF8C] mt-2 mx-auto"></div>
          </h2>
          <p className={`max-w-2xl mx-auto theme-text`}>
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-16 h-16 rounded-full overflow-hidden">
                  {testimonialsData[activeIndex].image &&
                  !remoteImageError[activeIndex] ? (
                    <img
                    ...
                    />
                  ) : testimonialsData[activeIndex].localImage &&
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="text-xl black font-semibold">
                        {testimonialsData[activeIndex].name}
                      </h3>
                      <p className="text-sm lightblack mb-2">
                        {testimonialsData[activeIndex].position}
                      </p>
                    </div>

                    <span
                      className={`text-xs px-2 py-1 rounded-full border text-black ${
                        relationColors[testimonialsData[activeIndex].relation] ||
                  ...
                  <div className="mt-4 relative">
                    <MessageSquareQuote className="absolute -top-2 -left-2 w-5 h-5 text-[#a50202] opacity-40" />
                    <p className="pl-4 black italic">
            ...
            <div className="flex justify-between mt-8">
              <motion.button
                ...
                className="p-2 rounded-full bg-transparent border border-[#00FF8C]/30 text-[#000000] hover:bg-[#00FF8C]/10 flex items-center justify-center"
