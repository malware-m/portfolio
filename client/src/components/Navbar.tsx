          ...
          <div className="flex space-x-6 mr-4">
            ...
            <div className="flex items-center">
              <a
                href="/Resume.pdf"
                download
                className="text-[#00FF8C] font-mono text-xl font-semibold hover:underline transition duration-300"
              >
                Download_CV
              </a>
            </div>
      ...
      >
        <div className="container mx-auto px-6 py-4 flex flex-col space-y-4">
          ...
          <a
            href="/Resume.pdf"
            download
            className="`text-white text-[#00FF8C] transition-colors duration-300 font-semibold"
          >
            Download_CV
          </a>
        </div>
