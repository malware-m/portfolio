    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      ...
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center">
          <span className="text-[#00FF8C] font-mono text-xl font-semibold">&gt;_malware.sh</span>
        </div>
        ...
        <div className="hidden md:flex items-center">
          <div className="flex space-x-6 mr-4">
            ...
            <a href="https://www.vulnsec.tech/blog" target="_blank" rel="noopener noreferrer" className={`text-white hover:text-[#00FF8C] transition-colors duration-300`}>Blog</a>
          </div>
        </div>
      ...
      <div className={`md:hidden bg-[#1A1A1A] border-gray-800 w-full border-t transition-all duration-300 ${isOpen ? 'block' : 'hidden'}`}>
        <div className="container mx-auto px-6 py-4 flex flex-col space-y-4">
          ...
          <a 
            href="https://www.vulnsec.tech/blog" 
            target="_blank" 
